		...
		switch (p->GetType())
		{
			...
			case props::IProperty::PROPERTY_TYPE::PT_INT:
			{
				switch (p->GetAspect())
				{
					...
					{
#if defined(_M_X64)
						pwp = new CWTFPropertyGridProperty(propname, (LONGLONG)(p->AsInt()), NULL, NULL, NULL, NULL, _T("0123456789-"));
#else
			...
			case props::IProperty::PROPERTY_TYPE::PT_INT_V4:
			{
				...
				pwp->AddSubItem(new CWTFPropertyGridProperty(xname, (LONGLONG)(p->AsVec2I()->x), NULL, NULL, NULL, NULL, _T("0123456789-")));
				pwp->AddSubItem(new CWTFPropertyGridProperty(yname, (LONGLONG)(p->AsVec2I()->y), NULL, NULL, NULL, NULL, _T("0123456789-")));
				if (p->GetAspect() >= props::IProperty::PROPERTY_TYPE::PT_INT_V3)
					pwp->AddSubItem(new CWTFPropertyGridProperty(zname, (LONGLONG)(p->AsVec3I()->z), NULL, NULL, NULL, NULL, _T("0123456789-")));
				if (p->GetAspect() == props::IProperty::PROPERTY_TYPE::PT_INT_V4)
					pwp->AddSubItem(new CWTFPropertyGridProperty(wname, (LONGLONG)(p->AsVec4I()->w), NULL, NULL, NULL, NULL, _T("0123456789-")));
...
#else
					v2.v[i] = pProp->GetSubItem(i)->GetValue().lVal;
#endif
				p->SetVec2I(v2);
				break;
			}
...
#else
					v3.v[i] = pProp->GetSubItem(i)->GetValue().lVal;
#endif
				p->SetVec3I(v3);
				break;
			}
...
#else
					v4.v[i] = pProp->GetSubItem(i)->GetValue().lVal;
#endif
				p->SetVec4I(v4);
				break;
			}
