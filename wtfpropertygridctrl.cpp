...
#define AFX_FORMAT_LONGLONG  _T("%I64d")
#define AFX_FORMAT_USHORT    _T("%u")
#define AFX_FORMAT_ULONG     _T("%u")
#define AFX_FORMAT_ULONGLONG _T("%U64d")
...
CString CWTFPropertyGridProperty::FormatProperty()
{
	...
	case VT_I8:
	case VT_INT:
		strVal.Format(AFX_FORMAT_LONGLONG, (long)var.llVal);
		break;
...
#endif
	case VT_UI8:
		strVal.Format(AFX_FORMAT_ULONGLONG, var.ullVal);
		break;
...
#else
		m_varValue.ullVal = strtoull(strText, NULL, 10);
#endif // _UNICODE
		return TRUE;
...
BOOL CWTFPropertyGridProperty::IsValueChanged() const
{
	...
	case VT_INT:
	case VT_I8:
		return(long)var.llVal != (long long)var1.llVal;
